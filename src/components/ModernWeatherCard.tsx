...
export const ModernWeatherCard = ({ weather, loading, error, onRefresh }: WeatherCardProps) => {
  if (loading) {
    return (
      <Card className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200 animate-pulse">
    ...
    return (
      <Card className="p-4 bg-gradient-to-br from-red-50 to-pink-50 border-red-200">
        <div className="flex items-center justify-between">
          ...
          {onRefresh && (
            <Button onClick={onRefresh} size="sm" className="bg-red-600 hover:bg-red-700 text-white">
  ...
  return (
    <Card className="p-4 bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 border-blue-200 shadow-md">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {onRefresh && (
          <Button onClick={onRefresh} variant="ghost" size="sm" className="text-blue-600 hover:text-blue-700 hover:bg-blue-100">
            <RefreshCw className="w-4 h-4" />
          </Button>
        )}
      </div>
